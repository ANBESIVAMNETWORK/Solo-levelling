...
## Setup
1. Copy files into a new repo/folder.
...
4. Register slash commands to your dev guild (fast) or globally:
   ...
   - Otherwise they'll be registered globally (may take up to an hour).
...
## Next steps
- Add more models (Inventory, Items, Skills)
- Add more commands and features (combat engine, dungeons)
- Add tests, CI, and a dashboard
- Populate content (hunters, shadows, bosses)
